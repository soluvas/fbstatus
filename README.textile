...
To deploy to local JBoss AS, you need to add a few environment variables. They are (with examples):

bc. OPENSHIFT_DATA_DIR = /together/project/AksiMata/fbstatus_data/ 
...
Count: 	168
Icon set page: 	http://pixel-mixer.com/
